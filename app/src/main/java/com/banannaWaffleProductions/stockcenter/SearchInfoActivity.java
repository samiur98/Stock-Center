...
public class SearchInfoActivity extends AppCompatActivity {
    //Class responsible for the SearchInfoActivity.
    //The SearchInfoActivity is responsible for displaying details on searched Stocks.
    private final static String TAG = SearchInfoActivity.class.getSimpleName();
    ...
    protected void onResume(){
        ...
        this.mTextView = findViewById(R.id.search_info_textView);
        this.mAddButton = findViewById(R.id.search_info_add_button);
        this.mAddButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(!userData.containsKey(detailedStock.getSymbol())) {
                    userData.put(detailedStock.getSymbol(), detailedStock);
                    String message = detailedStock.getSymbol() + " has been added to your list.";
                    Toast.makeText(SearchInfoActivity.this, message,
                            Toast.LENGTH_LONG).show();
                }
                else{
                    String message = detailedStock.getSymbol() +
                            " has already been added to your list.";
                    Toast.makeText(SearchInfoActivity.this, message,
                            Toast.LENGTH_LONG).show();
                }
            }
        });
        this.mBackButton = findViewById(R.id.search_info_back_button);
